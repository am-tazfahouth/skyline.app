...
class WeatherIconMapper {
  static IconData fromWeatherCode(int code, {bool isDay = true}) {
    ...
    if (code <= 3) return isDay ? WeatherIcons.day_cloudy : WeatherIcons.night_alt_cloudy;
    if (code <= 48) return isDay ? WeatherIcons.fog : WeatherIcons.night_fog;
    if (code <= 55) return isDay ? WeatherIcons.sprinkle : WeatherIcons.night_sprinkle;
    ...
    if (code <= 82) return isDay ? WeatherIcons.showers : WeatherIcons.night_showers;
